...
\section{CIDER}\smallskip \hrule height 2pt \smallskip
\begin{tabular}{p{5cm}p{1cm}} % {@{}ll@{}}
	
	Start Cider REPL & \verb!M-x cider-jack-in! \\
	Start Cider REPL & \verb!C-c M-j! \\
	Connect Cider REPL & \verb!M-x cider-connect! \\
	Close Cider REPL & \verb!M-x nrepl-close! \\
	Close all connections & \verb!M-x cider-quit! \\
